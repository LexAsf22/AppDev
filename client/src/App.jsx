...
const buildCSS = (dark) => `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-error {
    ...
    border-radius: 10px; border: 1px solid rgba(251,113,133,0.22);
    text-align: left;
  }
  .auth-submit {
  ...
  return (
    <div className="mockup-frame">
      <div className="mockup-bar">
        ...
        <div className="mockup-title">CosmoChat.chat — Channel 1</div>
      </div>
...
export default function App() {
  ...
  const features = [
    ...
    { icon: "🎙️", color: "#06b6d4", bg: "rgba(6,182,212,0.12)", title: "Crystal-Clear Voice Calls", desc: "One-click voice calls with WebRTC. Talk in real time with high-quality audio, directly in your browser." },
    { icon: "📹", color: "#ec4899", bg: "rgba(236,72,153,0.12)", title: "HD Video Calls", desc: "Face-to-face conversations with HD video calling. Picture-in-picture mode keeps you in the chat while you talk." },
    { icon: "🖼️", color: "#f59e0b", bg: "rgba(245,158,11,0.12)", title: "Rich Media Sharing", desc: "Share photos, files, and voice messages effortlessly. Drag, drop, and send — it's that simple." },
    { icon: "🔐", color: "#10b981", bg: "rgba(16,185,129,0.12)", title: "Secure Authentication", desc: "JWT-based authentication keeps your account safe. Your conversations are yours and yours alone." },
    { icon: "🌗", color: "#a855f7", bg: "rgba(168,85,247,0.12)", title: "Dark & Light Mode", desc: "A stunning animated background that adapts to your preference — deep space dark or crisp sky light." },
  ];
  ...
  /* ── LOGGED IN: show chat ── */
  if (auth) {
    return <WebSocketClient authUser={auth.username} authToken={auth.token} onLogout={handleLogout} />;
  }
      ...
      <div className="landing">
        ...
        <section className="section">
          ...
          <p className="section-sub">
            Built for teams and individuals who care about speed, quality, and a great experience.
          </p>
